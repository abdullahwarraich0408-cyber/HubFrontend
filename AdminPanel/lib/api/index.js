...
export const labPortalApi = {
  ...
  updateBookingStatus: (id, status) =>
    api.patch(`/partners/lab/bookings/${id}/status`, { status }),
...
export const adminGeneralApi = {
  ...
  getDoctorPracticeLocations: (id) => api.get(`/admin/doctors/${id}/practice-locations`),
  createDoctorPracticeLocation: (doctorId, data) => api.post(`/admin/doctors/${doctorId}/practice-locations`, data),
  updateDoctorPracticeLocation: (doctorId, locationId, data) =>
    api.patch(`/admin/doctors/${doctorId}/practice-locations/${locationId}`, data),
  deleteDoctorPracticeLocation: (doctorId, locationId) =>
    api.delete(`/admin/doctors/${doctorId}/practice-locations/${locationId}`),
  ...
  updateHospitalStatus: (id, is_active) => api.patch(`/admin/hospitals/${id}/status`, { is_active }),
