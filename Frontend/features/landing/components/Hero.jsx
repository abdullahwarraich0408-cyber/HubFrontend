  ...
  return (
    <section className="relative overflow-x-clip pb-10 pt-6 md:pb-16 md:pt-10 lg:pb-20 lg:pt-12">
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute -left-24 top-10 h-72 w-72 rounded-full bg-[#087F8C]/10 blur-3xl" />
      ...
      <div className="landing-container grid items-center gap-10 lg:grid-cols-2 lg:gap-12 xl:gap-16">
        <div className="order-1">
          ...
          <FadeIn delay={0.1}>
            <p className="mt-3 text-[15px] font-medium text-[#087F8C] md:text-[16px]">
          ...
          <FadeIn delay={0.25}>
            <p className="mt-6 max-w-md text-[13px] leading-relaxed text-[#7B8794]">
        ...
        <div className="order-2">
          <FadeIn delay={0.12} className="relative mx-auto max-w-[520px] overflow-visible lg:max-w-none">
            <div className="relative mx-2 aspect-[4/5] overflow-hidden rounded-[28px] border border-white/70 bg-[#EAF8F7] shadow-[0_24px_60px_rgba(16,42,67,0.12)] sm:mx-4 sm:rounded-[32px] lg:mx-6">
              <LandingImage
            ...
            <FloatingCard
              className="absolute -left-2 top-[12%] max-w-[200px] sm:-left-4 sm:max-w-[220px]"
            ...
            <FloatingCard
              className="absolute -right-1 top-[38%] max-w-[180px] sm:-right-3 sm:max-w-[200px]"
              reduceMotion={reduceMotion}
              delay={0.4}
            >
            ...
            <FloatingCard
              className="absolute bottom-[14%] left-[6%] max-w-[200px] sm:left-[8%] sm:max-w-[220px]"
              reduceMotion={reduceMotion}
              delay={0.8}
            >
            ...
            <motion.div
              className="absolute bottom-[22%] right-[6%] flex h-14 w-14 items-center justify-center rounded-2xl border border-white/80 bg-white/95 text-[#087F8C] shadow-[0_10px_30px_rgba(16,42,67,0.12)] sm:h-16 sm:w-16"
              animate={reduceMotion ? undefined : { y: [0, -6, 0] }}
              transition={{ duration: 4.5, repeat: Infinity, ease: "easeInOut", delay: 0.6 }}
              aria-hidden
            >
              <div className="relative">
                <Heart size={26} weight="fill" className="text-[#087F8C]" />
                <Pulse size={14} weight="bold" className="absolute -bottom-1 -right-2 text-[#16A085]" />
              </div>
            </motion.div>
          </FadeIn>
        </div>
