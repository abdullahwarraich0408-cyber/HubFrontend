...
/**
 * Simple top banner — same idea as a mobile in-app notification card.
 */
export function NotificationBannerHost() {
  ...
  return (
    <div className="fixed top-3 left-1/2 -translate-x-1/2 z-[100] w-[min(420px,calc(100vw-24px))] animate-in slide-in-from-top-2 fade-in duration-200">
